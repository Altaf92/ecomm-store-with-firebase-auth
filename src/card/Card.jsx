              ...
              <div key={id} className="p-2 md:w-1/4 w-full">
                ...
                >
                  ...
                  <div className=" flex  space-x-2 justify-between">
                    <button className="bg-[#444444] px-5 py-1.5 text-white rounded-lg">Add to Cart</button>
                    <button className="bg-[#4c050b] px-5 py-1.5 text-white rounded-lg">Buy Now</button>
                  </div>
                </div>
              </div>
            );
